...
.. cpp:function:: int botan_ec_scalar_one(botan_ec_scalar_t* ec_scalar, botan_ec_group_t ec_group);

   Create a scalar with a value of 1.
...
.. cpp:function:: int botan_ec_point_is_identity(botan_ec_point_t ec_point);
   ...
   Returns 1 if `ec_point` is equal to the groups identity element, otherwise 0.
...
.. cpp:function:: int botan_ec_privkey_get_private_key(botan_privkey_t key, botan_ec_scalar_t* value)
   ...
   Get the private point of the EC key.
