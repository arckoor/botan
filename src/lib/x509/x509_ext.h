...
class BOTAN_PUBLIC_API(3, 6) IPAddressBlocks final : public Certificate_Extension {
   public:
      enum class BOTAN_PUBLIC_API(3, 6) Version : uint8_t {
         IPv4 = 4,
         IPv6 = 16,
      };
      ...
      template <Version V>
      class BOTAN_PUBLIC_API(3, 6) IPAddressOrRange final : public ASN1_Object {
         public:
            void encode_into(DER_Encoder&) const override;
            void decode_from(class BER_Decoder& from) override;
      ...
      template <Version V>
      class BOTAN_PUBLIC_API(3, 6) IPAddressChoice final : public ASN1_Object {
         public:
            void encode_into(DER_Encoder&) const override;
      ...
      class BOTAN_PUBLIC_API(3, 6) IPAddressFamily final : public ASN1_Object {
         public:
            void encode_into(DER_Encoder&) const override;
            void decode_from(BER_Decoder& from) override;
...
class BOTAN_PUBLIC_API(3, 6) ASBlocks final : public Certificate_Extension {
   public:
      ...
      class BOTAN_PUBLIC_API(3, 6) ASIdOrRange final : public ASN1_Object {
         public:
            void encode_into(DER_Encoder&) const override;
            void decode_from(class BER_Decoder& from) override;
      ...
      class BOTAN_PUBLIC_API(3, 6) ASIdentifierChoice final : public ASN1_Object {
         public:
            void encode_into(DER_Encoder&) const override;
            void decode_from(class BER_Decoder& from) override;
      ...
      class BOTAN_PUBLIC_API(3, 6) ASIdentifiers final : public ASN1_Object {
         public:
            void encode_into(DER_Encoder&) const override;
            void decode_from(class BER_Decoder& from) override;
